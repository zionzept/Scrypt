...
// Note: \u0009 //is the unicode value for a line feed
...
public class Array implements Type {
	...
	@Override
	public Type getNull() {
		return this; // this is strange, but used so far just to get a returned
						// type. Probably want to get rid of getNull from stuff
						// that's not a primitive type
	}
	...
	public void addToStringBuilder(StringBuilder sb, int nestledness) {
		if (printArrayTypes)
			sb.append(type.getTypeName() + ":"); // Prints type contained in
													// array. e.g. {{1, 2, 3},
													// {4, 5, 6}} ->
													// int[]:{int:{1, 2, 3},
													// int:{4, 5, 6}}
